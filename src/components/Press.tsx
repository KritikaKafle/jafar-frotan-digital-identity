  ...
  const pressItems = [
    {
      ...
      description:
        "Encyclopedia entry covering Jafar Frotan's background, entrepreneurial ventures, and impact on the technology industry.",
      date: "2024",
      category: "Biography",
    ...
    },
    {
      ...
      publication: "Wikitia",
      description:
        "Comprehensive professional profile detailing career achievements, business ventures, and contributions to the technology sector.",
      date: "2024",
      category: "Biography",
    ...
    },
    {
      ...
      description:
        "An in-depth look at Jafar Frotan's entrepreneurial journey and how he built a successful technology company at a young age.",
      date: "September 2024",
    ...
    },
    {
      ...
      description:
        "Exploring Frotan's remarkable journey from founding Zeytoon ICT at age 12 to becoming a CEO, showcasing his blend of youthful ambition and business acumen.",
      date: "September 2024",
      category: "Entrepreneurship",
    ...
    },
    {
      ...
      description:
        "An inside look at the technology and vision behind Hekayat Shab, the innovative storytelling platform co-founded by Jafar Frotan.",
      date: "2024",
      category: "Technology",
    ...
    },
    {
      ...
      description:
        "Insights into Frotan's strategic approach to empowering tech startups and fostering innovation in the digital landscape.",
      date: "2024",
      category: "Innovation",
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Media coverage, interviews, and recognition highlighting the journey of innovation, entrepreneurship, and
            ...
            {recognitions.map((recognition, index) => (
              ...
              >
                <CardContent className="p-6">
                  ...
                  <h4 className="font-display text-lg font-semibold mb-2 text-foreground">{recognition.title}</h4>
                  <p className="text-primary font-medium text-sm mb-2">{recognition.organization}</p>
                  <p className="text-muted-foreground text-sm mb-3">{recognition.description}</p>
